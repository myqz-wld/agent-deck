...
- **Integration And Runtime**
  ...
  - **Experimental features**:
    ...
    - **Codex sandbox**: three-choice dropdown (Workspace Write / Read Only / Danger Full Access), aligned with Claude's default. Per-session changes apply from the next Codex turn without restarting the current turn; switching to Danger Full Access still asks for confirmation.
