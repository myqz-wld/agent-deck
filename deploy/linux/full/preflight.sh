...
validate_common() {
  ...
  require_line "$unit" 'ContainerName=agent-deck-full-%i'
  require_line "$unit" 'Label=io.agent-deck.instance=%i'
  require_line "$unit" 'Label=io.agent-deck.topology=full'
  require_line "$unit" 'Label=io.agent-deck.managed-by=agent-deck-instance-manager'
