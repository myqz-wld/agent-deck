...
//
// 跑法:
//   /workspace/example/.nvm/versions/node/v24.10.0/bin/node \
//     /workspace/example/agent-deck/.claude/worktrees/codex-handoff-team-alignment-20260518/spike-reports/spike3-runner.mjs
//
...
// - additionalDirectories=['/workspace/example/.claude']:claude 读 OAuth creds + 写 session jsonl

import { Codex } from 'file:///workspace/example/agent-deck/node_modules/.pnpm/@openai+codex-sdk@0.120.0/node_modules/@openai/codex-sdk/dist/index.js';

const CLAUDE_BIN = '/workspace/example/.nvm/versions/node/v24.10.0/bin/claude';
const NODE_BIN_DIR = '/workspace/example/.nvm/versions/node/v24.10.0/bin';
const WORKTREE = '/workspace/example/agent-deck/.claude/worktrees/codex-handoff-team-alignment-20260518';
...
async function runOneMode(sandboxMode) {
  ...
  const thread = codex.startThread({
    ...
    additionalDirectories: ['/workspace/example/.claude'],
  });
