...
1. **源码静态分析**:读 `/workspace/example/agent-deck/node_modules/.pnpm/@openai+codex-sdk@0.120.0/node_modules/@openai/codex-sdk/dist/index.js` 全文(467 行)看 `Codex` / `Thread` / `CodexExec` 三个 class 关系 + `spawn` 调用点
