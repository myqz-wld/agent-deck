...
import type { InternalSession, SdkSessionHandle } from './types';

export interface ClaudeCwdTransitionContext {
...
export interface ClaudeCwdTransitionHost {
...
export class ClaudeCwdTransitionControllerCore {
  constructor(
    private readonly context: ClaudeCwdTransitionContext,
    private readonly host: ClaudeCwdTransitionHost,
  ) {}
  ...
  async switchCwd(
    ...
    const record = this.host.getSession(transition.sessionId);
