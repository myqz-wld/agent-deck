...
export interface BuildClaudeQueryOptionsCoreArgs {
  cwd: string;
  permissionMode?: PermissionMode;
  resume?: string;
  canUseTool: CanUseTool;
  sandboxOpts: Pick<Options, 'sandbox'>;
  ...
  /** App-owned MCP tool namespace supplied by the desktop composition host. */
  agentDeckMcpToolPattern: string;
  mcpServers: {
 ...
 */
export function buildClaudeQueryOptionsCore(
  args: BuildClaudeQueryOptionsCoreArgs,
): Options {
  const {
    cwd,
    permissionMode,
  ...
  return {
    ...
    ...(agentDeckMcpServer
      ? {
          ...
          allowedTools: [agentDeckMcpToolPattern],
        }
      : {}),
