 ...
 *
 * Migration 范围 v001-v039（plan sqlite-tests-no-skip-20260601 D4 + codex-recover-network-dirs-parity-20260602）：
...
/**
 * In-memory SQLite + 跑 v001-v039 全部 migration 后返回 db 实例。
