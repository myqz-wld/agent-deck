 ...
 *
 * Migration 范围 v001-v041（plan sqlite-tests-no-skip-20260601 D4 + codex-recover-network-dirs-parity-20260602）：
...
/**
 * In-memory SQLite + 跑 v001-v041 全部 migration 后返回 db 实例。
...
export function makeMemoryDb(): Database.Database {
  ...
  for (const sql of [
    ...
    v031, v032, v033, v034, v035, v036, v037, v038, v039, v040, v041,
  ]) {
    db.exec(sql);
  }
  return db;
