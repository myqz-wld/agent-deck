...
export const CORE_METHOD_METADATA = {
  'desktop.broker.next': readMethod(AgentDeckCapability.Browser),
  'desktop.broker.respond': {
  ...
  'workspace.directory.list': readMethod(AgentDeckCapability.SessionConsoleRead),
  'workspace.directory.create': mutationMethod(
    AgentDeckCapability.WorkspaceDirectoryWrite,
    'none',
  ),
  'session.archive': mutationMethod(AgentDeckCapability.SessionHistoryWrite, 'none'),
  'session.unarchive': mutationMethod(AgentDeckCapability.SessionHistoryWrite, 'none'),
  ...
  'session.messages.list': readMethod(AgentDeckCapability.SessionMessagesRead),
  'session.outgoing.list': readMethod(AgentDeckCapability.SessionOutgoingRead),
  ...
  'session.events.list': readMethod(AgentDeckCapability.Replay),
  'session.summaries.list': readMethod(AgentDeckCapability.SessionSummariesRead),
  'session.file-changes.list': readMethod(AgentDeckCapability.SessionFileChangesRead),
  'session.file-changes.get': readMethod(AgentDeckCapability.SessionFileChangesRead),
  'session.file-changes.final-diff': readMethod(
    AgentDeckCapability.SessionFileChangesRead,
  ),
  'session.assets.image-chunk.read': readMethod(AgentDeckCapability.Assets),
  'session.tasks.list': readMethod(AgentDeckCapability.Tasks),
  'usage.tokens.get': readMethod(AgentDeckCapability.Usage),
  ...
  'issues.list': readMethod(AgentDeckCapability.Issues),
  'issues.get': readMethod(AgentDeckCapability.Issues),
  'issues.update': mutationMethod(AgentDeckCapability.Issues, 'required'),
  'issues.soft-delete': mutationMethod(AgentDeckCapability.Issues, 'required'),
  'issues.undelete': mutationMethod(AgentDeckCapability.Issues, 'required'),
  ...
  'pending.index.list': readMethod(AgentDeckCapability.PendingIndexRead),
  'pending.respond': mutationMethod(AgentDeckCapability.PendingRespond, 'required'),
  'plan.review.start': mutationMethod(AgentDeckCapability.PlanReview, 'required'),
  'plan.review.ask': mutationMethod(AgentDeckCapability.PlanReview, 'required'),
  'plan.review.feedback': mutationMethod(AgentDeckCapability.PlanReview, 'required'),
  ...
  'session.context.get': readMethod(AgentDeckCapability.SessionContextRead),
  'session.input.capabilities': readMethod(AgentDeckCapability.SessionInputRead),
