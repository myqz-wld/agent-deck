 ...
 *
 * 功能：让 claude / deepseek / codex / 第三方 MCP client 通过 18 个 tool 跨 adapter
  ...
  return (
    <Section title="Agent Deck MCP server" storageKey="agent-deck-mcp" defaultOpen={false}>
      ...
      <div className="text-[10px] leading-snug text-deck-muted/70">
        开启后,Claude / Deepseek / Codex / 任何支持 MCP 的 AI 客户端都能在会话里调用工具,编排其他会话、向用户展示计划或差异并收集反馈、管理团队任务并上报 issue。
