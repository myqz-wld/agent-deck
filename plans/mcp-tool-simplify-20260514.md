...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/mcp-tool-simplify-20260514"
status: "completed"
base_commit: "1ca0c85"
base_branch: "main"
...
```
EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/mcp-tool-simplify-20260514")
```
...
2. `EnterWorktree(path: "/workspace/example/.../mcp-tool-simplify-20260514")` 进 worktree
...
- 代码:`/workspace/example/agent-deck/.claude/worktrees/mcp-tool-simplify-20260514/src/...`
- 文档:`<worktree>/resources/claude-config/...`
- changelog:`<worktree>/changelog/...`

**例外**(plan 文件本身不在 worktree):
- plan: `/workspace/example/agent-deck/.claude/plans/mcp-tool-simplify-20260514.md`
- user CLAUDE.md: `/workspace/example/.claude/CLAUDE.md`
