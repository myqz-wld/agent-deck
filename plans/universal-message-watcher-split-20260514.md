...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/universal-message-watcher-split-20260514"
status: "completed"
base_commit: "cc9111a"
base_branch: "main"
...
`/workspace/example/agent-deck/.claude/worktrees/universal-message-watcher-split-20260514/...`
...
2. `mcp__agent-deck__archive_plan({ plan_id: 'universal-message-watcher-split-20260514', worktree_path: '/workspace/example/agent-deck/.claude/worktrees/universal-message-watcher-split-20260514', base_branch: 'main' })`
