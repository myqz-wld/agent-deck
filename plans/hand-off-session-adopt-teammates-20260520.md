...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/hand-off-session-adopt-teammates-20260520"
status: "completed"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/hand-off-session-adopt-teammates-20260520.md` 全文读(优先 §步骤 checklist Phase 7)
2. EnterWorktree(path: `/workspace/example/agent-deck/.claude/worktrees/hand-off-session-adopt-teammates-20260520`)— worktree 已存在(Phase 1-6 用过,clean,HEAD=`d52b3ad`)
