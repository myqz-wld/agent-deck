...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/archive-plan-tool-ux-followup-20260515"
status: "in_progress"
base_commit: "99f1e61"
base_branch: "main"
...
1. `Bash: cat /workspace/example/agent-deck/plans/archive-plan-tool-ux-followup-20260515.md` 全文读 plan(强制 cat 不用 Read)
2. `EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/archive-plan-tool-ux-followup-20260515")` 进 worktree
3. 自检 worktree HEAD == 99f1e61(本 stub 创建时 main HEAD):
   ```bash
   git -C /workspace/example/agent-deck/.claude/worktrees/archive-plan-tool-ux-followup-20260515 log --oneline -3
   ```
