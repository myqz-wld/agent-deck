...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/llm-handoff-summary-fallback-20260514"
status: "completed"
base_commit: "6273545"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/llm-handoff-summary-fallback-20260514.md`(**严禁** Read tool — 详 user CLAUDE.md §Step 3 cold-start callout)
2. `EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/llm-handoff-summary-fallback-20260514")` 进 worktree
...
prepend `<worktree-abs-path>/` = `/workspace/example/agent-deck/.claude/worktrees/llm-handoff-summary-fallback-20260514/` 后使用:
