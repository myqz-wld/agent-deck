...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/review-33-high-fix-20260513"
status: "completed"
base_commit: "e7c9be7"
base_branch: "main"
...
1. read `/workspace/example/agent-deck/.claude/worktrees/review-33-high-fix-20260513/src/main/teams/team-lifecycle-scheduler.ts:84-118` 的 scan() while-loop pagination
...
最后 Step 11：`ExitWorktree(action: "keep")` → `mcp__agent_deck__archive_plan({ plan_id: 'review-33-high-fix-20260513', worktree_path: '/workspace/example/agent-deck/.claude/worktrees/review-33-high-fix-20260513', base_branch: 'main' })`。
