...
| [archive-plan-tool-ux-followup-20260515.md](archive-plan-tool-ux-followup-20260515.md) | in_progress | — | REVIEW_44 §follow-up 4 项一并收口 stub(archive-plan-content-overwritten-fix-20260515 父 plan):(a) archive_plan default 路径不查 `<main-repo>/plans/<id>.md` + (b) INDEX 防重复 append 跳过 update 现有行 + (c) plans/INDEX.md header 4 列 vs auto-append 行 2 列错位 + (d) 7 phase GENERIC hint polish。worktree 已建,待新会话 Phase 1 设计对抗起手 |
