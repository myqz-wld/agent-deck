...
/workspace/example/.codex/skills/agent-deck/hello-from-deck/SKILL.md
/workspace/example/.codex/skills/agent-deck/deep-review/SKILL.md
```
...
5. codex 输出「Agent Deck 自带 skill 已就绪：hello-from-deck / cwd: /workspace/example/agent-deck / 时间戳：2026-05-19 21:36:51 CST」（21:37:03 ✅）
