...
worktree_path: /workspace/example/agent-deck/.claude/worktrees/mcp-bug-and-feature-batch-20260513
status: completed
base_commit: bfccc10
base_branch: main
...
```
按 /workspace/example/.claude/plans/mcp-bug-and-feature-batch-20260513.md 接力
```

cold start 必做：
1. `Bash: cat /workspace/example/.claude/plans/mcp-bug-and-feature-batch-20260513.md`（**严禁 Read tool**）
2. 从 frontmatter 拿 `worktree_path` → `EnterWorktree(path:"/workspace/example/agent-deck/.claude/worktrees/mcp-bug-and-feature-batch-20260513")`
