...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/cwd-resilience-fix-20260514"
status: "completed"
base_commit: "22d90e8"
base_branch: "main"
...
按 plan 进入 worktree(`EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/cwd-resilience-fix-20260514")`) → 找 plan checklist 下一个未勾 step → 直接动手。
...
- 代码:`/workspace/example/agent-deck/.claude/worktrees/cwd-resilience-fix-20260514/src/main/agent-deck-mcp/...`
- 文档:`<worktree>/resources/claude-config/...`
- changelog:`<worktree>/changelog/...`

**例外**(plan 文件本身不在 worktree):
- plan: `/workspace/example/agent-deck/.claude/plans/cwd-resilience-fix-20260514.md`
- user CLAUDE.md(D4 改): `/workspace/example/.claude/CLAUDE.md`
