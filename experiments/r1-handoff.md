...
- **Plan**：`/workspace/example/.claude/plans/magical-puzzling-muffin.md`（v3 用户已批准 + bypassPermissions）
...
Worktree：`/workspace/example/agent-deck/.claude/worktrees/r1-codex-parity/`
...
```bash
cd /workspace/example/agent-deck/.claude/worktrees/r1-codex-parity
...
参考：
- plan v3: /workspace/example/.claude/plans/magical-puzzling-muffin.md
