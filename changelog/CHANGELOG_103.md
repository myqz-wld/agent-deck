...
REVIEW_35 follow-up 优先级 1（5 真问题）+ 优先级 2（4 测试盲区）落地（plan `review-35-followup-p1-p2-20260514`）。1 commit 9 文件 +390/-36 = 修复真问题 + 测试补全 + 0 引入新功能。详见 [reviews/REVIEW_35.md §Follow-up plan 候选](../reviews/REVIEW_35.md#follow-up-plan-候选)。
