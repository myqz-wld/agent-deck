# CHANGELOG_47: 引入 reviews/ 双轨机制 + CLAUDE.md 简化对齐 + 反馈升级加 Agent 踩坑
...
- 本次开始严格遵守边界：纯加固 / bug 修复 / 性能优化 → reviews/REVIEW_X.md；新功能 / API / 依赖升级 / 机制变更 → changelog/CHANGELOG_X.md。CHANGELOG_47 本身属于「机制变更」（引入 reviews/ 机制），所以记录在 changelog
