# CHANGELOG_143 — hand-off cold-start 特殊渲染 / create session 图片显示 / 图片放大查看
...
详异构对抗 review finding 表见下方「R1 异构对抗 review fix」节。归档 plan [handoff-render-and-image-batch-20260521.md](../plans/handoff-render-and-image-batch-20260521.md)。
