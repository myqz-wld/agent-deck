...
| cwd | `/workspace/example/agent-deck` | **空字符串** | `/workspace/example/agent-deck` |
...
reviewer-claude finding 文件:`$TMPDIR/reviewer_claude_out.bH0oFN`
reviewer-codex finding 文件:`$TMPDIR/reviewer_codex_out.bnrswr`
