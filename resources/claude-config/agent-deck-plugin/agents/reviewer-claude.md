...
> **严重度枚举**（5 档）：HIGH / MED / LOW / **INFO**（提示性、不影响合并）/ ***未验证*** —— 与 `resources/claude-config/CLAUDE.md` §Finding 输出契约 节一致，reviewer-codex（codex-cli adapter native, codex SDK 直起 gpt-5.5）按同款 5 档输出。
