...
When code changes need isolation, create a detached worktree from an explicit Git `startPoint`. Claude Code may use native worktree capability; when Agent Deck worktree markers or cross-adapter alignment are required, use MCP:
