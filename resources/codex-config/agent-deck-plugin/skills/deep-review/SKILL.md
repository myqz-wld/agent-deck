...
**单方独有分流**：HIGH → §Step 4 反驳轮；MED → lead 自己 grep / cat 验证（≤ 5min / ≤ 5 grep / ≤ 1 test，超就降非 HIGH 不再纠缠）；LOW/INFO → 直接列 ❓。双方都说没问题 → ✅ 可合。
