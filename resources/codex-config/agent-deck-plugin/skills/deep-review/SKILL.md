...
- **③** 降级单方非 CRITICAL/HIGH 走当前 §99 fast path (失去补对方视角,但 §三态裁决 §单方独有分流 保障 single-side CRITICAL/HIGH 不被错升级)
