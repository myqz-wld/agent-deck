...
R1 reviewer 切片由 lead 映射为 plan 字母编号（详 [plan §设计决策](../plans/deep-review-and-refactor-r37-20260515.md)，本 REVIEW 引用 SSOT 不复述）：
...
详 [plan §Step 4.2 / 4.4 / 4.6 注释](../plans/deep-review-and-refactor-r37-20260515.md)。R3 双方独立验证跳过理由站得住（实地 grep + 文件 LOC 实测 + IPC handler 抽样）。简要：
...
- [plans/deep-review-and-refactor-r37-20260515.md](../plans/deep-review-and-refactor-r37-20260515.md)（archive 后路径）
