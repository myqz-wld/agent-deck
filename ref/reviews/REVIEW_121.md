...
- Trigger: follow-up optimization after [CHANGELOG_282](../changelogs/CHANGELOG_282.md), where archived team rows were skipped at handoff transfer time but call sites still mixed row-active and operational membership semantics.
...
- Related changelog: [CHANGELOG_284.md](../changelogs/CHANGELOG_284.md).
