...
- Read `CLAUDE.md`, `AGENTS.md`, packaged Codex/Claude conventions, the invocation plan, and `ref/reviews/recent-month/REVIEW_267_compatibility-dead-code-audit.md`. Findings below refer to existing HEAD code, not deleted compatibility paths.
