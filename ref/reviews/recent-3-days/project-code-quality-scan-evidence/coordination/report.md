...
- Revalidated against `ref/reviews/recent-month/REVIEW_267_compatibility-dead-code-audit.md`; no deleted Image MCP, retired Local Browser front, or removed module is reported here.
