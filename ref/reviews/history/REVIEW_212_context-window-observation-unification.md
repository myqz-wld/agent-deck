...
baseline_commit: c680b0cfd522747bef68d1240c5cbfdf939d4549
expired: false
skipped_expired:
  - file: "ref/**"
...
# REVIEW_212_context-window-observation-unification: Deep review of observed continuation capacity
...
- Mainline conflict integration retained the independently landed Claude/Codex cumulative-token and
  live-rate fixes alongside exact context-capacity evidence. The merged tree passed 12 focused files
  / 158 tests, the full Electron-ABI suite (465 files / 3,845 tests, one live smoke skipped),
  typecheck, build, logger, review-expiry, legacy-consumer, diff, production-size, and an isolated
  schema-v62/MCP restart smoke.
...
override, paid probe, transcript estimate, or public trusted-capacity input was introduced. The
mainline merge retained that verdict and passed the merged-tree validation gates above.

## Related records

- `CHANGELOG_430_context-window-observation-unification.md`
