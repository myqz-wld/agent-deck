...
- 未把 `send_message` MCP 缺失问题混入本条 MCP 描述修法；该问题由 [`REVIEW_114.md`](./REVIEW_114.md) / [`CHANGELOG_257.md`](../../changelogs/history/CHANGELOG_257.md) 单独收口。
...
- [`CHANGELOG_256.md`](../../changelogs/history/CHANGELOG_256.md)
