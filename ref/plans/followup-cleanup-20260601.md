...
worktree_path: /workspace/example/agent-deck/.claude/worktrees/followup-cleanup-20260601
status: completed
...
进 worktree `/workspace/example/agent-deck/.claude/worktrees/followup-cleanup-20260601`，按 Group A→D 顺序实施。所有代码路径用 worktree 内绝对路径。
