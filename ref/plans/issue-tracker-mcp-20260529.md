...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/issue-tracker-mcp-20260529"
status: "completed"
...
cold start 路径：
- 本 plan: /workspace/example/agent-deck/.claude/plans/issue-tracker-mcp-20260529.md
- worktree: /workspace/example/agent-deck/.claude/worktrees/issue-tracker-mcp-20260529
