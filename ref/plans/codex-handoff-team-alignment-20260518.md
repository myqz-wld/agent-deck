...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/codex-handoff-team-alignment-20260518"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/codex-handoff-team-alignment-20260518.md` 读全 plan v4.1
2. `EnterWorktree(path: /workspace/example/agent-deck/.claude/worktrees/codex-handoff-team-alignment-20260518)` 进 worktree（用 `path` 不是 `name`）
