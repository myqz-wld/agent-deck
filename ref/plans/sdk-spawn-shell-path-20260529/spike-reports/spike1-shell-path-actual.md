...
/usr/sbin
/sbin
/workspace/example/Library/Application Support/agent-deck/agent-deck-plugin/bin
```
...
输出:
```
/workspace/example/.mavis/bin
/workspace/example/.opencode/bin
/workspace/example/.bun/bin
/workspace/example/.claude
/workspace/example/.antigravity/antigravity/bin
/workspace/example/.nvm/versions/node/v24.10.0/bin
/workspace/example/.gvm/pkgsets/go1.19/global/bin
/workspace/example/.gvm/gos/go1.19/bin
/workspace/example/.gvm/pkgsets/go1.19/global/overlay/bin
/workspace/example/.gvm/bin
/opt/homebrew/bin
/opt/homebrew/sbin
/usr/local/bin
...
| 缺失路径 | 用途 |
|---|---|
| /workspace/example/.mavis/bin | 用户自定义 |
| /workspace/example/.opencode/bin | 用户工具 |
| /workspace/example/.bun/bin | Bun 运行时 |
| /workspace/example/.claude | Claude 自家 |
| /workspace/example/.antigravity/antigravity/bin | 用户工具 |
| /workspace/example/.nvm/versions/node/v24.10.0/bin | **nvm Node 24 (含 pnpm corepack shim)** |
| /workspace/example/.gvm/* (4 条) | Go 版本管理 |
...
| /workspace/example/.cargo/bin | **Rust cargo binaries** |
...
/workspace/example/.nvm/versions/node/v24.10.0/bin/pnpm
10.33.0
```
...
/workspace/example/.cargo/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:...
