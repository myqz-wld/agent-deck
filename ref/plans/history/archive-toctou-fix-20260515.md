...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/archive-toctou-fix-20260515"
status: "completed"
base_commit: "1456824"
base_branch: "main"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/archive-toctou-fix-20260515.md` 全文(看当前阶段 + 已踩坑)
2. `EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/archive-toctou-fix-20260515")` 进同一 worktree(用 `path` 不是 `name`)
