...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/remove-aider-generic-pty-adapters-20260520"
status: "completed"
...
**下一会话接力第一步**(P2 起手):
- `Bash: cat /workspace/example/agent-deck/.claude/plans/remove-aider-generic-pty-adapters-20260520.md` 全文读
- `EnterWorktree(path: /workspace/example/agent-deck/.claude/worktrees/remove-aider-generic-pty-adapters-20260520)`
...
如果是新会话接力:
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/remove-aider-generic-pty-adapters-20260520.md` 全文读
2. 看 frontmatter `worktree_path` → `EnterWorktree(path: /workspace/example/agent-deck/.claude/worktrees/remove-aider-generic-pty-adapters-20260520)`
3. `git -C /workspace/example/agent-deck/.claude/worktrees/remove-aider-generic-pty-adapters-20260520 log --oneline -3` 确认 HEAD ≥ base_commit
