...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/hand-off-mcp-archive-opt-20260515"
status: "completed"
base_commit: "d635dad"
base_branch: "main"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/hand-off-mcp-archive-opt-20260515.md` 全文读 plan
