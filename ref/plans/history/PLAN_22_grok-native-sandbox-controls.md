...
base_branch: main
base_commit: 92dc3ba012574110a629b314b0e007a64752185a
related_changelog: CHANGELOG_406
---

# PLAN_22_grok-native-sandbox-controls: Complete native sandbox parity
...
- Electron-ABI `pnpm test` passed 396 files / 3,320 tests on merged `main`, with one opt-in
  credentialed Codex smoke skipped.
...
- Behavior record:
  `ref/changelogs/recent-3-days/CHANGELOG_406_grok-native-sandbox-controls.md`.
- Prompt inventory:
