...
- 改动 8 文件 / +410/-61 LOC
- 详 [`changelog/CHANGELOG_123.md`](../../changelogs/history/CHANGELOG_123.md)
...
1. `Bash: cat /workspace/example/agent-deck/plans/archive-plan-tool-ux-followup-20260515.md` 全文(本 plan 文件 — 在 main-repo `plans/` 而非 worktree 内)
