...
const CWD = process.env.SPIKE_CWD || '/workspace/example/agent-deck';
...
const PROMPTS = [
  '读取 /workspace/example/agent-deck/package.json，告诉我 version 字段的值。',
  '再读取 /workspace/example/agent-deck/tsconfig.node.json，告诉我它 extends 什么。',
  '用 Grep 在 /workspace/example/agent-deck/package.json 里找 electron 出现在哪些行。',
