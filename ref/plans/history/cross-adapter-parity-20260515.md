...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/cross-adapter-parity-20260515"
status: "completed"
base_commit: "d635dad"
base_branch: "main"
...
--
-- 字段值:JSON array of absolute paths,e.g. `["/workspace/example/repo"]`。NULL = 不指定
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/cross-adapter-parity-20260515.md` 全文读 plan
