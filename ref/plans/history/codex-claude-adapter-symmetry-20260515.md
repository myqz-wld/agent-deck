...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/codex-claude-adapter-symmetry-20260515"
status: "completed"
base_commit: "91c4568"
base_branch: "main"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/codex-claude-adapter-symmetry-20260515.md` 全文读 plan
2. `EnterWorktree(path: "/workspace/example/agent-deck/.claude/worktrees/codex-claude-adapter-symmetry-20260515")` 进 worktree(用 `path` 不是 `name`)
