...
base_branch: "main"
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/sdk-spawn-shell-path-20260529"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/sdk-spawn-shell-path-20260529.md` 全文读 plan(本节更新到 Round 2 fix)
