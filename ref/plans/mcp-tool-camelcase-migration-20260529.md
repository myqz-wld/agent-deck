...
base_branch: "main"
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/mcp-tool-camelcase-migration-20260529"
...
- [ ] `git -C /workspace/example/agent-deck worktree add -b worktree-mcp-tool-camelcase-migration-20260529 /workspace/example/agent-deck/.claude/worktrees/mcp-tool-camelcase-migration-20260529`
- [ ] `EnterWorktree(path: /workspace/example/agent-deck/.claude/worktrees/mcp-tool-camelcase-migration-20260529)`(用 path 不用 name 避开 v2.1.112 stale base bug)
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/mcp-tool-camelcase-migration-20260529.md` 全文读 plan(已含 R1+R2+R3+R4+R5 fix 共 49 处)
...
4. **invoke `agent-deck:deep-review` SKILL R6**(完整 Skill() 命令形式):
   ```
   Skill(skill: "agent-deck:deep-review", args: '{"kind": "plan", "paths": ["/workspace/example/agent-deck/.claude/plans/mcp-tool-camelcase-migration-20260529.md"]}')
   ```
