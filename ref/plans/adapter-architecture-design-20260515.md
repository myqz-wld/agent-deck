...
worktree_path: "/workspace/example/agent-deck/.claude/worktrees/adapter-architecture-design-20260515"
status: "completed"
base_commit: "d635dad"
base_branch: "main"
...
1. `Bash: cat /workspace/example/agent-deck/.claude/plans/adapter-architecture-design-20260515.md` 全文读 plan
