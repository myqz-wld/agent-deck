...
| [sdk-bridge-architecture.puml](sdk-bridge-architecture.puml) | active | commit 627a0c2 + 5b66cd8 / [REVIEW_60](../reviews/REVIEW_60.md) | sdk-bridge 双端模块架构(5 大块对偶,SDK 子进程 + jsonl 边界) |
| [sdk-bridge-state-machine.puml](sdk-bridge-state-machine.puml) | active | commit 627a0c2 + 5b66cd8 / [REVIEW_60](../reviews/REVIEW_60.md) | sdk-bridge 5 entity 跨层 state 联动(内存 Map/lifecycle/单飞锁/rename) |
