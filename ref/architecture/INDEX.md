...
|---|---|---|---|
| [agent-deck-mcp-architecture.puml](agent-deck-mcp-architecture.puml) | active | commit 7475b75 + d5549c6 + 8a41517 / [REVIEW_59](../reviews/REVIEW_59.md) / [CHANGELOG_189](../changelogs/CHANGELOG_189.md) | MCP 服务器顶层概览(5 大块 + 跨切组件 + cross-ref 各主题子图; 18 tool / 5 数据表含 issue) |
