...
# CHANGELOG_406_grok-native-sandbox-controls: Control Grok's native sandbox
...
- Electron-ABI `pnpm test` passed 396 files and 3,320 tests on merged `main`; one opt-in
  credentialed Codex smoke remained skipped.
