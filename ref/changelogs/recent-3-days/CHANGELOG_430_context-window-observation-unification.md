...
# CHANGELOG_430_context-window-observation-unification: Unify observed context capacity across continuations
...
- Mainline merge validation preserved both this feature and the independently landed provider-token
  accounting/rate repairs: 12 conflict-focused files / 158 tests and the full Electron-ABI suite
  (465 files / 3,845 tests, plus the same skipped live smoke) passed, followed by typecheck, build,
  logger, review-expiry, legacy-consumer, diff, production-size, and isolated restart checks.
...
- `REVIEW_212_context-window-observation-unification.md`
