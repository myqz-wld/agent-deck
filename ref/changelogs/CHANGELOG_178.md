...
[plan `runtime-logging-electron-log-20260529`](../plans/runtime-logging-electron-log-20260529.md) 完整收口归档。引入 [electron-log v5](https://github.com/megahertz/electron-log) 让 macOS .app 双击启动场景下 console.* 输出真正落盘(原 minimal launchd 启动无终端 → stdout/stderr 全丢, plan §不变量 1 根本目标)。
...
- Plan: [`ref/plans/runtime-logging-electron-log-20260529.md`](../plans/runtime-logging-electron-log-20260529.md) (archive_plan 同步入 git)
