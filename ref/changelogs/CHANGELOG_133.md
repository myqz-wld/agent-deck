...
- 归档 plan: [`plans/add-claude-cli-path-override-and-bump-sdks-20260520.md`](../plans/add-claude-cli-path-override-and-bump-sdks-20260520.md)
- spike-reports: [`plans/add-claude-cli-path-override-and-bump-sdks-20260520/spike-reports/`](../plans/add-claude-cli-path-override-and-bump-sdks-20260520/spike-reports/)(spike1 claude SDK bump / spike2 codex SDK bump / spike3 claudeCliPath design 验证)
