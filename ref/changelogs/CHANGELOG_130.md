...
详 [`plans/reviewer-codex-cross-adapter-20260519.md`](../plans/reviewer-codex-cross-adapter-20260519.md) + spike-reports/ 子目录(spike1+2 cross-adapter teammate dispatch / spike3 codex SDK dormant resume audit / spike4 codex CLI 加载 SKILL)。
