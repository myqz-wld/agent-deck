...
`heterogeneous_dual_completed: true`(plan Round 1-8 + code Round 1-3 双方异构对偶共识)。详 [`plans/hand-off-session-adopt-teammates-20260520.md`](../plans/hand-off-session-adopt-teammates-20260520.md)。
