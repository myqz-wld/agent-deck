...
详归档 plan [`plans/reverse-rename-sid-stability-20260520.md`](../plans/reverse-rename-sid-stability-20260520.md) §设计决策 D1-D8 + §不变量 5 条 + §spike-reports 4 个 mini-runner 实证 + Step A.5 R1 MED-D test 1-17 完整矩阵覆盖。
