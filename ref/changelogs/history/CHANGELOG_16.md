...
把 changelog 边界重新划清：`changelog/` 只放功能变更；新建 `reviews/` 目录放 debug / 性能 / 安全 review 报告。三份 CLAUDE.md 简化对齐，约定升级流程加入双对抗三态裁决。配套首份 `REVIEW_1.md`（main 进程双对抗 review，8 处修复）已落地，详见 [`reviews/REVIEW_1.md`](../../reviews/history/REVIEW_1.md)。
...
### 代码（详见 [REVIEW_1.md](../../reviews/history/REVIEW_1.md)）
