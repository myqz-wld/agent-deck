...
经 §Step 0 RFC 3 轮收口 + §Step 1.5 plan deep-review 3 轮 33 finding fix（双 reviewer 0 HIGH GO）+ §Step 25 mixed code+plan implementation deep-review 3 轮 12 finding fix（双 reviewer 0 HIGH/MED GO）。归档 plan [`plans/task-mcp-merge-into-agent-deck-mcp-20260521.md`](../../plans/history/task-mcp-merge-into-agent-deck-mcp-20260521.md)。
