...
两键各自 toggle：再按一次恢复上次「自定义」尺寸（共享 `preferredSize` 记忆字段）。改完后用户主动触发 `deep-code-review` SKILL,异构对抗 review 跑了 4 轮 × fix 收口,详 [REVIEW_45.md](../../reviews/history/REVIEW_45.md)。
...
## 4 轮 review × fix 历程（详 [REVIEW_45.md](../../reviews/history/REVIEW_45.md)）
