...
详 plan [`plans/assets-codex-user-and-ui-unify-20260521.md`](../../plans/history/assets-codex-user-and-ui-unify-20260521.md)(D1-D7 七项设计决策 + 不变量 #1-#10 + 已知踩坑 §1-§9 + Phase 1-4 步骤 checklist)。
