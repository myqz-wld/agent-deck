...
- 归档 plan: [`plans/add-claude-cli-path-override-and-bump-sdks-20260520.md`](../../plans/history/add-claude-cli-path-override-and-bump-sdks-20260520.md) §设计决策 D5+D7+D9 + §Follow-up
