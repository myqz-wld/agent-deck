...
- 父 plan(REVIEW_44 收口):[archive-plan-content-overwritten-fix-20260515.md](../../plans/history/archive-plan-content-overwritten-fix-20260515.md)(CHANGELOG_122)
- 兄弟 plan(本轮也建):[mcp-server-hot-reload-investigation-20260515.md](../../plans/history/mcp-server-hot-reload-investigation-20260515.md)(本 plan 收口 dogfooding 撞同款 mcp server 不 hot reload 问题)
